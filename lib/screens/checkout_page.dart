            ...
            Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text("Subtotal", style: s1),
                    Text("\$${subtotal.toStringAsFixed(2)}", style: s1)
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Delivery", style: s1),
                    Text("\$${delivery.toStringAsFixed(2)}", style: s1)
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Discount", style: s1),
                    Text("-\$${discount.toStringAsFixed(2)}", style: s1)
                  ],
                ),
                const Divider(),
                Row(
                  ...
                  children: [
                    Text("Total", style: s2),
                    Text("\$${total.toStringAsFixed(2)}", style: s2)
                  ],
                ),
              ],
            ),
